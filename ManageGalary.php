...
<?php
  ...
  $UploadByUserId=$rec["UploadByUserId"];
    print("<tr><td style='font-size:25pt;padding:40px'>$date</td>");
    print("<td  style='font-size:25pt;padding:40px'>$UploadByUserId</td>");
    print("<td  style='font-size:25pt;padding:40px'>$AnimalCategory</td>");
