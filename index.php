...
<div id="mySidenav" class="sidenav">
  ...
  <form class="form" style="width: 90%;padding-left: 10px" method="post" action="LoginCheck.php">
				<div class="form-group" >
					<h1  style="color:white;">Admin Zone</h1>
					<label for="uid" style="color:white;">User ID</label>
...
<span style="font-size:30px;font-weight:bold;cursor:pointer" onclick="openNav()">&#9776;</span>
